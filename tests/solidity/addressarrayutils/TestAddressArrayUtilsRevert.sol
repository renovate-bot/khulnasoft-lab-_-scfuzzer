...
contract TEST {
  ...
  function scfuzzer_find() public view returns (bool) {
    if (!everSet) {
      return true;
    }
    uint256 i;
  ...
  function scfuzzer_append() public view returns (bool) {
    if (!everSet) {
      return true;
    }    
  ...
  function scfuzzer_extend() public view returns (bool) {
    if (!everSet) {
      return true;
    }    
  ...
  function scfuzzer_sExtend() public returns (bool) {
    if (!everSet) {
      return true;
    }
  ...
  function scfuzzer_hasDuplicate() public view returns (bool) {
    if (!everSet) {
      return true;
    }
    bool hasDup = false;
  ...
  function scfuzzer_isEqual() public view returns (bool) {
    if (!everSet) {
      return true;
    }    
  ...
  function scfuzzer_sReverse() public returns (bool) {
    if (!everSet) {
      return true;
    }    
  ...
  function scfuzzer_diff() public view returns (bool) {
    if (!everSet) {
      return true;
    }
  ...
  function scfuzzer_union() public view returns (bool) {
    if (!everSet) {
      return true;
    }
    address [] memory empty = new address[](0);
  ...
  function scfuzzer_intersect() public view returns (bool) {
    if (!everSet) {
      return true;
    }
    address [] memory empty = new address[](0);
  ...
  function scfuzzer_remove() public view returns (bool) {
    if (!everSet) {
      return true;
    }    
    if (!AddressArrayUtils.contains(addrs1, a)) {
  ...
  function scfuzzer_revert_remove() public view returns (bool) {
    if (!everSet) {
      revert();
    }
    if (AddressArrayUtils.contains(addrs1, a)) {
  ...
  function scfuzzer_pop() public view returns (bool) {
    if (!everSet) {
      return true;
    }    
    if (!AddressArrayUtils.contains(addrs1, a)) {
  ...
  function scfuzzer_sRemoveCheap() public returns (bool) {
    if (!everSet) {
      return true;
    }    
    if (!AddressArrayUtils.contains(addrs1, a)) {
  ...
  function scfuzzer_revert_sRemoveCheap() public returns (bool) {
    if (!everSet) {
      revert();
    }
    if (AddressArrayUtils.contains(addrs1, a)) {
  ...
  function scfuzzer_sPop() public returns (bool) {
    if (!everSet) {
      return true;
    }    
    if (!AddressArrayUtils.contains(addrs1, a)) {
  ...
  function scfuzzer_revert_sPop() public returns (bool) {
    if (!everSet) {
      revert();
    }
  ...
  function scfuzzer_sPopCheap() public returns (bool) {
    if (!everSet) {
      return true;
    }    
    if (!AddressArrayUtils.contains(addrs1, a)) {
  ...
  function scfuzzer_revert_sPopCheap() public returns (bool) {
    if (!everSet) {
      revert();
    }
    uint256 index = addrs1.length;
  ...
  function scfuzzer_argGet() public view returns (bool) {
    if (!everSet) {
      return true;
    }
    if (addrs1.length < 1) {
