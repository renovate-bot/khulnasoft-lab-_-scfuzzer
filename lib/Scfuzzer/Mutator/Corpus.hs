module Scfuzzer.Mutator.Corpus where

import Control.Monad.Random.Strict (MonadRandom, getRandomR, weighted)
import Data.Set (Set)
import Data.Set qualified as Set

import Scfuzzer.Mutator.Array
import Scfuzzer.Transaction (mutateTx, shrinkTx)
import Scfuzzer.Types (MutationConsts)
import Scfuzzer.Types.Tx (Tx)
import Scfuzzer.Types.Corpus
