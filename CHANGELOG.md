...
* Renamed scfuzzer-test binary to scfuzzer (#826)
...
* Run scfuzzer tests in parallel (#571)
...
* Improved `khulnasoft-compile` error handling when missing (#335)
...
* `Tx` rework to unify `Scfuzzer.RPC` and `Transaction` (#346)
...
* Support `khulnasoft` arguments (#280)
